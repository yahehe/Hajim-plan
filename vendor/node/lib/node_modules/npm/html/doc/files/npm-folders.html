...
<!-- Mirrored from dancat2.herokuapp.com/vendor/node/lib/node_modules/npm/html/doc/files/npm-folders.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 16 Apr 2014 20:23:26 GMT -->
<meta http-equiv="content-type" value="text/html;utf-8">
  <link rel="stylesheet" type="text/css" href="../../static/style.css">

  <body>
    <div id="wrapper">
<h1><a href="npm-folders.html">npm-folders</a></h1> <p>Folder Structures Used by npm</p>
...
cannot be found elsewhere.  See <code><a href="package.json.html">package.json(5)</a></code> for more information.</p>

<h2 id="SEE-ALSO">SEE ALSO</h2>

<ul><li><a href="../misc/npm-faq.html">npm-faq(7)</a></li><li><a href="package.json.html">package.json(5)</a></li><li><a href="../cli/npm-install.html">npm-install(1)</a></li><li><a href="../cli/npm-pack.html">npm-pack(1)</a></li><li><a href="../cli/npm-cache.html">npm-cache(1)</a></li><li><a href="../cli/npm-config.html">npm-config(1)</a></li><li><a href="npmrc.html">npmrc(5)</a></li><li><a href="../misc/npm-config.html">npm-config(7)</a></li><li><a href="../cli/npm-publish.html">npm-publish(1)</a></li></ul>
</div>
